 ...
 */
var walkingChallenge: [String] = ["Walk 3 miles a day", "Walk 5 miles a day"]
var runnigChallenge: [String] = ["Run 5 times a week.", "Run 7 times a week."]
/*:
 ...
 */
var challenges: [[String]] = [walkingChallenge, runnigChallenge]
...
if commitedChallenges.isEmpty {
    print("Try to commit a challenge.")
