 ...
 */
var guillermo = User(name: "Guillermo", age: 21, height: 178, weight: 80, activityLevel: 6)
print("\(guillermo.name), \(guillermo.age), with a height of \(guillermo.height) cm and a weight of \(guillermo.weight) kg, has activity level of \(guillermo.activityLevel)")
/*:
 ...
 */
var otherDistance = Distance(feet: 6)
