...
junior.hasSuffix("Jr.") ? print("We found a second generation name!") : print("")
/*:
...
textToSearchThrough.lowercased().contains(textToSearchFor.lowercased()) ? print("I found it!") : print("")
/*:
