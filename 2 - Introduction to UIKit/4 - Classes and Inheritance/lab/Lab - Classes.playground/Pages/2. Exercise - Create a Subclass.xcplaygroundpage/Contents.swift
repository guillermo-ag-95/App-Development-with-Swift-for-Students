...
class Fighter: Spaceship {
    ...
    func fire() {
        remainingFirePower > 0 ? remainingFirePower -= 1 : print("You have no more fire power.")
    }
}
/*:
 ...
 */
print("It does not work because falcon is not defined in this page of the playground.")
/*:
