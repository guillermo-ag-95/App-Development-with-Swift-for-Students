...
print("The first example does not work because you are calling a local variable outside of its scope")
/*:
...
print("This code compiles because every variable is called in a valid scope.")
print("x is defined in a global scope and it is modified in a local scope, the for scope.")
print("foo is defined in the for scope but it's never used.")
/*:
