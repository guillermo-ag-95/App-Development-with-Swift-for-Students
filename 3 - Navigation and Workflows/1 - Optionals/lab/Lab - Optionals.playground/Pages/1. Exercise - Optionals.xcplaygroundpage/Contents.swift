...
print("userAge is a nil because the Int initializer could not return a value due to the typo.")
/*:
...
if let unwrappedUserAge = userAge {
    print("The user age is \(unwrappedUserAge)")
}

if let unwrappedUserAge = userAge2 {
    print("The user age is \(unwrappedUserAge)")
}
